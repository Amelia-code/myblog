...
const handleThemeSwitch = () => {
  ...
  return (
    ...
    <div className="w-full bg-white flex flex-col py-[30px] justify-center items-center dark:bg-slate-800">
       <div className ="w-full flex justify-end relative">
       <button className="flex border-0 py-1 px-3 rounded text-base mt-4 md:mt-0 absolute
                focus:outline-none
                bg-gray-100
                hover:bg-gray-50
